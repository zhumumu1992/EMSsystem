...
function getThisPage(page){
	$.ajax({
		type: "get",
		url: "http://47.92.37.168:1992/getDataArr/paging",
		cache:true,
		data:{
			'thisPage':page//当前页码
		},
...
$(".selectLine").change(function(){
	...
	$.ajax({
		type: "get",
		url: "http://47.92.37.168:1992/selectDepa/department",
		cache:true,
		data:{
...
$('.table').delegate('.deleteData','click',function(){
	...
	if(sessionStorage.admin_id == '1' || sessionStorage.admin_id == '2'){
		...
		$('.yes').on('click',function(){
			$.ajax({
				type:"get",
				url:"http://47.92.37.168:1992/deleteCustomerInfo/delete",
				cache:true,
				data:{
					id:thisID
				},
...
function search(){
	...
	$.ajax({
		type:"post",
		url:"http://47.92.37.168:1992/search/searchResult",
		cache:true,
		data:{
