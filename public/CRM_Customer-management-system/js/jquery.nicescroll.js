	...
	var A = window.MutationObserver || window.WebKitMutationObserver ||
		...
		P = function() {
			...
			a: { k = ["-moz-grab", "-webkit-grab", "grab"]; if(c.ischrome && !c.ischrome22 || c.isie) k = []; for(l = 0; l < k.length; l++)
				...
				k = "url(http://www.google.com/intl/en_ALL/mapfiles/openhand.cur),n-resize" } c.cursorgrabvalue = k;
		...
		Q = function(h, c) {
			...
			this.init = function() {
				...
				if(!b.ispage || !g.cantouch &&
							...
							b.ontouchstart = function(d) {
								...
								if(!b.locked) {
									...
									if(b.ispage || !b.opt.directionlockdeadzone) b.rail.drag.dl =
										...
										b.rail.drag.ck || (b.rail.drag.dl = "f") } b.opt.touchbehavior && (b.isiframe && g.isie) && (f = b.win.position(), b.rail.drag.x += f.left, b.rail.drag.y += f.top);
									b.hasmoving = !1;
									b.lastmouseup = !1;
							...
							b.ontouchmove = function(d, c) {
								...
								if(b.rail.drag && 2 == b.rail.drag.pt) {
									...
									if(b.railh && b.railh.scrollable) { var m = b.rail.drag.sl - h;
										b.ishwscroll && b.opt.bouncescroll ? 0 > m ? m = Math.round(m / 2) : m > b.page.maxw && (m = b.page.maxw + Math.round((m - b.page.maxw) / 2)) : (0 > m && (l = m = 0), m > b.page.maxw && (m = b.page.maxw, l = 0)) } f = !1;
							...
							var p = function(d) {
								if(b.selectiondrag) {
									if(d) { var c = b.win.outerHeight();
										...
										0 < d && d < c && (d = 0);
										d >= c && (d -= c);
										b.selectiondrag.df = d } 0 != b.selectiondrag.df && (b.doScrollBy(2 *
					...
					if(g.ischrome &&
						...
						b.win.css("width", f);
						b.synched("chromefix", function() { b.win.attr("style", s) }) } b.onAttributeChange = function(d) { b.lazyResize(250) };
			...
			this.doScrollBy = function(c, g) {
				...
				if(b.bouncescroll) { var e = Math.round(b.view.h / 2);
					f < -e ? f = -e : f > b.page.maxh + e && (f = b.page.maxh + e) } b.cursorfreezed = !1;
				py = b.getScrollTop(!0);
				if(0 > f &&
			...
			this.doScrollLeftBy = function(c, g) { var f = 0,
					...
					f < -e ? f = -e : f > b.page.maxw + e && (f = b.page.maxw + e) } b.cursorfreezed = !1;
			...
			this.doZoomIn = function(c) {
				if(!b.zoomactive) {
					...
					for(l in k) { var h = k[l];
						b.zoomrestore.style[h] = "undefined" != typeof f[h] ? f[h] : "" } b.zoomrestore.style.width = b.win.css("width");
